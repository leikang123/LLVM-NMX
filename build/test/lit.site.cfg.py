## Autogenerated from /volumes/hello2/nmx/llvm/test/lit.site.cfg.py.in
## Do not edit!
...
config.llvm_lib_dir = "/volumes/hello2/nmx/build/./lib"
config.llvm_shlib_dir = "/volumes/hello2/nmx/build/./lib"
...
config.targets_to_build = " AArch64 AMDGPU ARM BPF Hexagon Lanai Mips MSP430 NVPTX PowerPC Sparc SystemZ WebAssembly X86 XCore NMX"
...
lit_config.load_config(config, "/volumes/hello2/nmx/llvm/test/lit.cfg.py")
