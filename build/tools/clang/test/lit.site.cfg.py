## Autogenerated from /volumes/hello2/nmx/llvm/tools/clang/test/lit.site.cfg.py.in
## Do not edit!
...
config.clang_src_dir = "/volumes/hello2/nmx/llvm/tools/clang"
config.clang_tools_dir = "/volumes/hello2/nmx/build/./bin"
...
lit_config.load_config(config, "/volumes/hello2/nmx/llvm/tools/clang/test/lit.cfg.py")
