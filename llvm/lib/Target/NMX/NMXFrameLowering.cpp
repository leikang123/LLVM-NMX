//===-- NMXFrameLowering.cpp - Frame Information for NMX ------*- C++ -*-===//
//
...
const NMXFrameLowering *NMXFrameLowering::create(const NMXSubtarget &ST) {
    return llvm::createNMXSEFrameLowering(ST);
}
...
bool NMXFrameLowering::hasFP(const MachineFunction &MF) const {
...
MachineBasicBlock::iterator NMXFrameLowering::
