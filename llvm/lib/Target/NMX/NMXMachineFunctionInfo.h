//===-- NMXMachineFunctionInfo.h - Private data used for NMX --*- C++ -*-===//
//
...
#ifndef LLVM_LIB_TARGET_NMX_NMXMACHINEFUNCTIONINFO_H
#define LLVM_LIB_TARGET_NMX_NMXMACHINEFUNCTIONINFO_H
...
namespace llvm {
  // This class is derived from MachienFunction private NMX target-specific
  // information for each MachineFunction.
  class NMXMachineFunctionInfo : public MachineFunctionInfo {
  public:
    NMXMachineFunctionInfo(MachineFunction &MF)
        : MF(MF),
